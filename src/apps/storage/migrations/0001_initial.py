# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-09-17 22:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_shop', models.DecimalField(decimal_places=2, max_digits=8, verbose_name='Заведение')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('kind_name', models.CharField(db_index=True, max_length=40, unique=True, verbose_name='Название вида товара')),
