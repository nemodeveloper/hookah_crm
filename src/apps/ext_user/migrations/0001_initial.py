# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-06-19 12:07
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('session_status', models.CharField(choices=[('OPEN', 'Открыта'), ('CLOSE', 'Закрыта'), ('OVER', 'Просрочена'), ('UNKNOW', 'Неизвестно')], default='UNKNOW', max_length=10, verbose_name='Статус')),
                ('start_workday', models.DateTimeField(default=datetime.datetime(2016, 6, 19, 15, 7, 24, 578498), verbose_name='Начало рабочего дня')),
                ('end_workday', models.DateTimeField(null=True, verbose_name='Конец рабочего дня')),
